<?php
	// Header.
	$strPageTitle = " :: Calendar :. Edit Event";
...
<tr>
	...
	<td width="100%" align="left" valign="top" class="medium"><b><a href="index.php"><?php echo(htmlsanitize($CFG['general']['name'])); ?></a> &gt; <a href="calendar.php">Calendar</a> &gt; Edit Event</b></td>
</tr>
</table>
...
<tr>
	...
	<td bgcolor="<?php echo($CFG['style']['table']['cella']); ?>" class="medium"><?php echo($aEventInfo['private'] ? 'Private' : 'Public'); ?> Event</td>
</tr>
