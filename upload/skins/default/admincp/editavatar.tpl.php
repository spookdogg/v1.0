<?php
	// Header
	$strPageTitle = ' :: Admin Control Panel :. Edit Avatar';
...
<tr>
	...
	<td width="100%" align="left" valign="top" class="medium"><b><a href="index.php"><?php echo(htmlsanitize($CFG['general']['name'])); ?></a> &gt; <a href="admincp.php">Admin Control Panel</a> &gt; <a href="admincp.php?section=avatars">Public Avatars</a> &gt; Edit Avatar</b></td>
</tr>
</table><br />
...
<input type="hidden" name="avatarid" value="<?php echo($aAvatar['id']); ?>" />
<table cellpadding="4" cellspacing="1" border="0" bgcolor="<?php echo($CFG['style']['table']['bgcolor']); ?>" align="center" width="100%">

<tr class="section">
	<td colspan="2" align="center" class="medium">Edit Public Avatar</td>
</tr>
