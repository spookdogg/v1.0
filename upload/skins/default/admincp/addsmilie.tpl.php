<?php
	// Header
	$strPageTitle = ' :: Admin Control Panel :. Add Smilie';
...
<tr>
	...
	<td width="100%" align="left" valign="top" class="medium"><b><a href="index.php"><?php echo(htmlsanitize($CFG['general']['name'])); ?></a> &gt; <a href="admincp.php">Admin Control Panel</a> &gt; <a href="admincp.php?section=smilies">Smilies</a> &gt; Add New Smilie</b></td>
</tr>
</table><br />
...
<tr class="section">
	<td colspan="2" align="center" class="medium">Add New Smilie</td>
</tr>
...
<div style="text-align: center;"><br /><input type="submit" name="submit" value="Add Smilie" accesskey="s" /></div>
</form>
