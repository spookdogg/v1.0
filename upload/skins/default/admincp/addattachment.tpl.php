<?php
	// Header
	$strPageTitle = ' :: Admin Control Panel :. Add Attachment Type';
...
<tr>
	...
	<td width="100%" align="left" valign="top" class="medium"><b><a href="index.php"><?php echo(htmlsanitize($CFG['general']['name'])); ?></a> &gt; <a href="admincp.php">Admin Control Panel</a> &gt; <a href="admincp.php?section=attachments">Attachments</a> &gt; Add New Attachment Type</b></td>
</tr>
</table><br />
...
<tr class="section">
	<td colspan="2" align="center" class="medium">Add New Attachment Type</td>
</tr>

<tr>
	<td bgcolor="<?php echo($CFG['style']['table']['cellb']); ?>" class="medium"><b>File Extension</b></td>
	<td bgcolor="<?php echo($CFG['style']['table']['cellb']); ?>"><input type="text" name="extension" size="35" maxlength="255" value="<?php echo(urlencode($aAttachment['extension'])); ?>" /></td>
</tr>
...
<div style="text-align: center;"><br /><input type="submit" name="submit" value="Add Attachment Type" accesskey="s" /></div>
</form>
