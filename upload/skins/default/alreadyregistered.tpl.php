...
<table bgcolor="<?php echo($CFG['style']['table']['bgcolor']); ?>" width="70%" cellspacing="1" cellpadding="4" border="0" align="center">
	...
	<tr><td class="medium" bgcolor="<?php echo($CFG['style']['table']['cella']); ?>" style="text-align: justify;">Our records show that you have already registered at this forum under the name of <code><?php echo(htmlsanitize($_SESSION['username'])); ?></code>. If you have lost your password, click <a href="member.php?action=forgotdetails">here</a>. If you would like to modify your profile, click <a href="usercp.php?section=profile">here</a>.</td></tr>
</table>
