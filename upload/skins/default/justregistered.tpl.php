...
<table bgcolor="<?php echo($CFG['style']['table']['bgcolor']); ?>" width="70%" cellspacing="1" cellpadding="4" border="0" align="center">
	...
	<tr><td class="medium" bgcolor="<?php echo($CFG['style']['table']['cella']); ?>" style="text-align: justify;">Thank you for registering! An e-mail has been sent to your inbox with details on how to activate your account. You will not be able to login or otherwise use your account until you have activated it.<br /><br />Click <a href="index.php">here</a> to return to the forum index.</td></tr>
</table>
