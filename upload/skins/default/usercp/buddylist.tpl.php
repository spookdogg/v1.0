...
<tr>
	...
	<td width="100%" align="left" valign="top" class="medium"><b><a href="index.php"><?php echo(htmlsanitize($CFG['general']['name'])); ?></a> &gt; <a href="usercp.php">User Control Panel</a> &gt; Edit Buddy List</b></td>
</tr>
</table><br />
...
<input type="hidden" name="section" value="buddylist" />
<table cellpadding="4" cellspacing="1" border="0" bgcolor="<?php echo($CFG['style']['table']['bgcolor']); ?>" width="200" align="center">

<tr class="section"><td align="center" class="medium">Edit Buddy List</td></tr>
...
<?php
	...
	if(is_array($aUsernames))
	{
		foreach($aUsernames as $strUsername)
		{
			...
			echo("		<input type=\"text\" name=\"buddylist[]\" value=\"{$strUsername}\" size=\"30\" maxlength=\"{$CFG['maxlen']['username']}\" /><br />\n");
		}
	}
?>
		<input type="text" name="buddylist[]" size="30" maxlength="<?php echo($CFG['maxlen']['username']); ?>" /><br />
		<input type="text" name="buddylist[]" size="30" maxlength="<?php echo($CFG['maxlen']['username']); ?>" />
	</td>
</tr>
