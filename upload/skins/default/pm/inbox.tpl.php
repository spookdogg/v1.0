...
<tr>
	...
	<td width="100%" align="left" valign="top" class="medium"><b><a href="index.php"><?php echo(htmlsanitize($CFG['general']['name'])); ?></a> &gt; <a href="usercp.php">User Control Panel</a> &gt; <a href="private.php">Private Messages</a> &gt; Inbox</b></td>
</tr>
</table><br />
...
<tr>
	...
	<form action="private.php" method="post">
		...
		<select name="id" onchange="window.location=('private.php?action=viewfolder&amp;id=' + this.options[this.selectedIndex].value);">
			<option value="0" selected="selected">Inbox</option>
...
<tr class="heading">
	...
	<td align="center" class="smaller" width="20%">Author</td>
	<td align="center" class="smaller" nowrap="nowrap">Date/Time Received</td>
	<td align="center" class="smaller"><input type="checkbox" name="checkall" onclick="check();" /></td>
</tr>
...
<?php
	foreach($aMessages as $iMessageID => $aMessage)
	{
		...
		if($aMessage[REPLIED])
		{
			...
			$aMessage[STATUS][URL] = 'images/message_replied.png';
			$aMessage[STATUS][ALT] = 'Replied To Message';
		}
		else if($aMessage[BEENREAD])
		{
...
<tr class="heading"><td class="smaller" colspan="6">
	...
	<tr class="smaller">
		<td align="right" width="100%">Selected message(s):&nbsp;</td>
<?php
	// Print out all of the custom folders.
	if(count($aFolders))
	{
...
?>
	...
	<td class="smaller" align="right"><?php echo(TimeInfo()); ?></td>
</tr>
</table>
